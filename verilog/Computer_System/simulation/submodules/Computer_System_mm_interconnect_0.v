...
module Computer_System_mm_interconnect_0 (
		...
		input  wire         Bus_master_video_reset_reset_bridge_in_reset_reset,                    //                    Bus_master_video_reset_reset_bridge_in_reset.reset
		input  wire         VGA_Subsystem_sys_reset_reset_bridge_in_reset_reset,                   //                   VGA_Subsystem_sys_reset_reset_bridge_in_reset.reset
		input  wire [29:0]  Bus_master_video_avalon_master_address,                                //                                  Bus_master_video_avalon_master.address
		output wire         Bus_master_video_avalon_master_waitrequest,                            //                                                                .waitrequest
		input  wire [0:0]   Bus_master_video_avalon_master_byteenable,                             //                                                                .byteenable
		input  wire         Bus_master_video_avalon_master_read,                                   //                                                                .read
		output wire [7:0]   Bus_master_video_avalon_master_readdata,                               //                                                                .readdata
		input  wire         Bus_master_video_avalon_master_write,                                  //                                                                .write
		input  wire [7:0]   Bus_master_video_avalon_master_writedata,                              //                                                                .writedata
	...
	wire          bus_master_video_avalon_master_translator_avalon_universal_master_0_waitrequest;                     // Bus_master_video_avalon_master_agent:av_waitrequest -> Bus_master_video_avalon_master_translator:uav_waitrequest
	wire    [7:0] bus_master_video_avalon_master_translator_avalon_universal_master_0_readdata;                        // Bus_master_video_avalon_master_agent:av_readdata -> Bus_master_video_avalon_master_translator:uav_readdata
	wire          bus_master_video_avalon_master_translator_avalon_universal_master_0_debugaccess;                     // Bus_master_video_avalon_master_translator:uav_debugaccess -> Bus_master_video_avalon_master_agent:av_debugaccess
	wire   [31:0] bus_master_video_avalon_master_translator_avalon_universal_master_0_address;                         // Bus_master_video_avalon_master_translator:uav_address -> Bus_master_video_avalon_master_agent:av_address
	wire          bus_master_video_avalon_master_translator_avalon_universal_master_0_read;                            // Bus_master_video_avalon_master_translator:uav_read -> Bus_master_video_avalon_master_agent:av_read
	wire    [0:0] bus_master_video_avalon_master_translator_avalon_universal_master_0_byteenable;                      // Bus_master_video_avalon_master_translator:uav_byteenable -> Bus_master_video_avalon_master_agent:av_byteenable
	wire          bus_master_video_avalon_master_translator_avalon_universal_master_0_readdatavalid;                   // Bus_master_video_avalon_master_agent:av_readdatavalid -> Bus_master_video_avalon_master_translator:uav_readdatavalid
	wire          bus_master_video_avalon_master_translator_avalon_universal_master_0_lock;                            // Bus_master_video_avalon_master_translator:uav_lock -> Bus_master_video_avalon_master_agent:av_lock
	wire          bus_master_video_avalon_master_translator_avalon_universal_master_0_write;                           // Bus_master_video_avalon_master_translator:uav_write -> Bus_master_video_avalon_master_agent:av_write
	wire    [7:0] bus_master_video_avalon_master_translator_avalon_universal_master_0_writedata;                       // Bus_master_video_avalon_master_translator:uav_writedata -> Bus_master_video_avalon_master_agent:av_writedata
	wire    [0:0] bus_master_video_avalon_master_translator_avalon_universal_master_0_burstcount;                      // Bus_master_video_avalon_master_translator:uav_burstcount -> Bus_master_video_avalon_master_agent:av_burstcount
	wire          rsp_mux_002_src_valid;                                                                               // rsp_mux_002:src_valid -> Bus_master_video_avalon_master_agent:rp_valid
	wire  [101:0] rsp_mux_002_src_data;                                                                                // rsp_mux_002:src_data -> Bus_master_video_avalon_master_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                                               // Bus_master_video_avalon_master_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [3:0] rsp_mux_002_src_channel;                                                                             // rsp_mux_002:src_channel -> Bus_master_video_avalon_master_agent:rp_channel
	wire          rsp_mux_002_src_startofpacket;                                                                       // rsp_mux_002:src_startofpacket -> Bus_master_video_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                                                         // rsp_mux_002:src_endofpacket -> Bus_master_video_avalon_master_agent:rp_endofpacket
	...
	wire          bus_master_video_avalon_master_agent_cp_valid;                                                       // Bus_master_video_avalon_master_agent:cp_valid -> router_002:sink_valid
	wire  [101:0] bus_master_video_avalon_master_agent_cp_data;                                                        // Bus_master_video_avalon_master_agent:cp_data -> router_002:sink_data
	wire          bus_master_video_avalon_master_agent_cp_ready;                                                       // router_002:sink_ready -> Bus_master_video_avalon_master_agent:cp_ready
	wire          bus_master_video_avalon_master_agent_cp_startofpacket;                                               // Bus_master_video_avalon_master_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          bus_master_video_avalon_master_agent_cp_endofpacket;                                                 // Bus_master_video_avalon_master_agent:cp_endofpacket -> router_002:sink_endofpacket
	...
	wire          onchip_sram_s1_agent_rp_valid;                                                                       // Onchip_SRAM_s1_agent:rp_valid -> router_004:sink_valid
	wire  [128:0] onchip_sram_s1_agent_rp_data;                                                                        // Onchip_SRAM_s1_agent:rp_data -> router_004:sink_data
	wire          onchip_sram_s1_agent_rp_ready;                                                                       // router_004:sink_ready -> Onchip_SRAM_s1_agent:rp_ready
	wire          onchip_sram_s1_agent_rp_startofpacket;                                                               // Onchip_SRAM_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          onchip_sram_s1_agent_rp_endofpacket;                                                                 // Onchip_SRAM_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [101:0] router_003_src_data;                                                                                 // router_003:src_data -> VGA_Subsystem_pixel_dma_master_limiter:cmd_sink_data
	...
	wire  [101:0] vga_subsystem_pixel_dma_master_limiter_cmd_src_data;                                                 // VGA_Subsystem_pixel_dma_master_limiter:cmd_src_data -> cmd_demux_003:sink_data
	...
	wire  [101:0] rsp_mux_003_src_data;                                                                                // rsp_mux_003:src_data -> VGA_Subsystem_pixel_dma_master_limiter:rsp_sink_data
	...
	wire  [101:0] vga_subsystem_pixel_dma_master_limiter_rsp_src_data;                                                 // VGA_Subsystem_pixel_dma_master_limiter:rsp_src_data -> VGA_Subsystem_pixel_dma_master_agent:rp_data
	...
	wire  [128:0] cmd_mux_src_data;                                                                                    // cmd_mux:src_data -> Onchip_SRAM_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                                                   // Onchip_SRAM_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                                                                 // cmd_mux:src_channel -> Onchip_SRAM_s1_burst_adapter:sink0_channel
	...
	wire          cmd_demux_src0_valid;                                                                                // cmd_demux:src0_valid -> ARM_A9_HPS_h2f_axi_master_wr_to_Onchip_SRAM_s1_cmd_width_adapter:in_valid
	wire  [236:0] cmd_demux_src0_data;                                                                                 // cmd_demux:src0_data -> ARM_A9_HPS_h2f_axi_master_wr_to_Onchip_SRAM_s1_cmd_width_adapter:in_data
	wire          cmd_demux_src0_ready;                                                                                // ARM_A9_HPS_h2f_axi_master_wr_to_Onchip_SRAM_s1_cmd_width_adapter:in_ready -> cmd_demux:src0_ready
	wire    [3:0] cmd_demux_src0_channel;                                                                              // cmd_demux:src0_channel -> ARM_A9_HPS_h2f_axi_master_wr_to_Onchip_SRAM_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_src0_startofpacket;                                                                        // cmd_demux:src0_startofpacket -> ARM_A9_HPS_h2f_axi_master_wr_to_Onchip_SRAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_src0_endofpacket;                                                                          // cmd_demux:src0_endofpacket -> ARM_A9_HPS_h2f_axi_master_wr_to_Onchip_SRAM_s1_cmd_width_adapter:in_endofpacket
	wire          arm_a9_hps_h2f_axi_master_wr_to_onchip_sram_s1_cmd_width_adapter_src_valid;                          // ARM_A9_HPS_h2f_axi_master_wr_to_Onchip_SRAM_s1_cmd_width_adapter:out_valid -> cmd_mux:sink0_valid
	wire  [128:0] arm_a9_hps_h2f_axi_master_wr_to_onchip_sram_s1_cmd_width_adapter_src_data;                           // ARM_A9_HPS_h2f_axi_master_wr_to_Onchip_SRAM_s1_cmd_width_adapter:out_data -> cmd_mux:sink0_data
	wire          arm_a9_hps_h2f_axi_master_wr_to_onchip_sram_s1_cmd_width_adapter_src_ready;                          // cmd_mux:sink0_ready -> ARM_A9_HPS_h2f_axi_master_wr_to_Onchip_SRAM_s1_cmd_width_adapter:out_ready
	wire    [3:0] arm_a9_hps_h2f_axi_master_wr_to_onchip_sram_s1_cmd_width_adapter_src_channel;                        // ARM_A9_HPS_h2f_axi_master_wr_to_Onchip_SRAM_s1_cmd_width_adapter:out_channel -> cmd_mux:sink0_channel
	wire          arm_a9_hps_h2f_axi_master_wr_to_onchip_sram_s1_cmd_width_adapter_src_startofpacket;                  // ARM_A9_HPS_h2f_axi_master_wr_to_Onchip_SRAM_s1_cmd_width_adapter:out_startofpacket -> cmd_mux:sink0_startofpacket
	wire          arm_a9_hps_h2f_axi_master_wr_to_onchip_sram_s1_cmd_width_adapter_src_endofpacket;                    // ARM_A9_HPS_h2f_axi_master_wr_to_Onchip_SRAM_s1_cmd_width_adapter:out_endofpacket -> cmd_mux:sink0_endofpacket
	...
	wire          cmd_demux_001_src0_valid;                                                                            // cmd_demux_001:src0_valid -> ARM_A9_HPS_h2f_axi_master_rd_to_Onchip_SRAM_s1_cmd_width_adapter:in_valid
	wire  [236:0] cmd_demux_001_src0_data;                                                                             // cmd_demux_001:src0_data -> ARM_A9_HPS_h2f_axi_master_rd_to_Onchip_SRAM_s1_cmd_width_adapter:in_data
	wire          cmd_demux_001_src0_ready;                                                                            // ARM_A9_HPS_h2f_axi_master_rd_to_Onchip_SRAM_s1_cmd_width_adapter:in_ready -> cmd_demux_001:src0_ready
	wire    [3:0] cmd_demux_001_src0_channel;                                                                          // cmd_demux_001:src0_channel -> ARM_A9_HPS_h2f_axi_master_rd_to_Onchip_SRAM_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_001_src0_startofpacket;                                                                    // cmd_demux_001:src0_startofpacket -> ARM_A9_HPS_h2f_axi_master_rd_to_Onchip_SRAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_001_src0_endofpacket;                                                                      // cmd_demux_001:src0_endofpacket -> ARM_A9_HPS_h2f_axi_master_rd_to_Onchip_SRAM_s1_cmd_width_adapter:in_endofpacket
	wire          arm_a9_hps_h2f_axi_master_rd_to_onchip_sram_s1_cmd_width_adapter_src_valid;                          // ARM_A9_HPS_h2f_axi_master_rd_to_Onchip_SRAM_s1_cmd_width_adapter:out_valid -> cmd_mux:sink1_valid
	wire  [128:0] arm_a9_hps_h2f_axi_master_rd_to_onchip_sram_s1_cmd_width_adapter_src_data;                           // ARM_A9_HPS_h2f_axi_master_rd_to_Onchip_SRAM_s1_cmd_width_adapter:out_data -> cmd_mux:sink1_data
	wire          arm_a9_hps_h2f_axi_master_rd_to_onchip_sram_s1_cmd_width_adapter_src_ready;                          // cmd_mux:sink1_ready -> ARM_A9_HPS_h2f_axi_master_rd_to_Onchip_SRAM_s1_cmd_width_adapter:out_ready
	wire    [3:0] arm_a9_hps_h2f_axi_master_rd_to_onchip_sram_s1_cmd_width_adapter_src_channel;                        // ARM_A9_HPS_h2f_axi_master_rd_to_Onchip_SRAM_s1_cmd_width_adapter:out_channel -> cmd_mux:sink1_channel
	wire          arm_a9_hps_h2f_axi_master_rd_to_onchip_sram_s1_cmd_width_adapter_src_startofpacket;                  // ARM_A9_HPS_h2f_axi_master_rd_to_Onchip_SRAM_s1_cmd_width_adapter:out_startofpacket -> cmd_mux:sink1_startofpacket
	wire          arm_a9_hps_h2f_axi_master_rd_to_onchip_sram_s1_cmd_width_adapter_src_endofpacket;                    // ARM_A9_HPS_h2f_axi_master_rd_to_Onchip_SRAM_s1_cmd_width_adapter:out_endofpacket -> cmd_mux:sink1_endofpacket
	...
	wire          cmd_demux_002_src0_valid;                                                                            // cmd_demux_002:src0_valid -> Bus_master_video_avalon_master_to_Onchip_SRAM_s1_cmd_width_adapter:in_valid
	wire  [101:0] cmd_demux_002_src0_data;                                                                             // cmd_demux_002:src0_data -> Bus_master_video_avalon_master_to_Onchip_SRAM_s1_cmd_width_adapter:in_data
	wire          cmd_demux_002_src0_ready;                                                                            // Bus_master_video_avalon_master_to_Onchip_SRAM_s1_cmd_width_adapter:in_ready -> cmd_demux_002:src0_ready
	wire    [3:0] cmd_demux_002_src0_channel;                                                                          // cmd_demux_002:src0_channel -> Bus_master_video_avalon_master_to_Onchip_SRAM_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_002_src0_startofpacket;                                                                    // cmd_demux_002:src0_startofpacket -> Bus_master_video_avalon_master_to_Onchip_SRAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_002_src0_endofpacket;                                                                      // cmd_demux_002:src0_endofpacket -> Bus_master_video_avalon_master_to_Onchip_SRAM_s1_cmd_width_adapter:in_endofpacket
	wire          bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_valid;                        // Bus_master_video_avalon_master_to_Onchip_SRAM_s1_cmd_width_adapter:out_valid -> cmd_mux:sink2_valid
	wire  [128:0] bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_data;                         // Bus_master_video_avalon_master_to_Onchip_SRAM_s1_cmd_width_adapter:out_data -> cmd_mux:sink2_data
	wire          bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_ready;                        // cmd_mux:sink2_ready -> Bus_master_video_avalon_master_to_Onchip_SRAM_s1_cmd_width_adapter:out_ready
	wire    [3:0] bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_channel;                      // Bus_master_video_avalon_master_to_Onchip_SRAM_s1_cmd_width_adapter:out_channel -> cmd_mux:sink2_channel
	wire          bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_startofpacket;                // Bus_master_video_avalon_master_to_Onchip_SRAM_s1_cmd_width_adapter:out_startofpacket -> cmd_mux:sink2_startofpacket
	wire          bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_endofpacket;                  // Bus_master_video_avalon_master_to_Onchip_SRAM_s1_cmd_width_adapter:out_endofpacket -> cmd_mux:sink2_endofpacket
	wire          cmd_demux_002_src1_valid;                                                                            // cmd_demux_002:src1_valid -> Bus_master_video_avalon_master_to_SDRAM_s1_cmd_width_adapter:in_valid
	wire  [101:0] cmd_demux_002_src1_data;                                                                             // cmd_demux_002:src1_data -> Bus_master_video_avalon_master_to_SDRAM_s1_cmd_width_adapter:in_data
	wire          cmd_demux_002_src1_ready;                                                                            // Bus_master_video_avalon_master_to_SDRAM_s1_cmd_width_adapter:in_ready -> cmd_demux_002:src1_ready
	wire    [3:0] cmd_demux_002_src1_channel;                                                                          // cmd_demux_002:src1_channel -> Bus_master_video_avalon_master_to_SDRAM_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_002_src1_startofpacket;                                                                    // cmd_demux_002:src1_startofpacket -> Bus_master_video_avalon_master_to_SDRAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_002_src1_endofpacket;                                                                      // cmd_demux_002:src1_endofpacket -> Bus_master_video_avalon_master_to_SDRAM_s1_cmd_width_adapter:in_endofpacket
	wire          bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_valid;                              // Bus_master_video_avalon_master_to_SDRAM_s1_cmd_width_adapter:out_valid -> cmd_mux_001:sink2_valid
	wire  [110:0] bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_data;                               // Bus_master_video_avalon_master_to_SDRAM_s1_cmd_width_adapter:out_data -> cmd_mux_001:sink2_data
	wire          bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_ready;                              // cmd_mux_001:sink2_ready -> Bus_master_video_avalon_master_to_SDRAM_s1_cmd_width_adapter:out_ready
	wire    [3:0] bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_channel;                            // Bus_master_video_avalon_master_to_SDRAM_s1_cmd_width_adapter:out_channel -> cmd_mux_001:sink2_channel
	wire          bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_startofpacket;                      // Bus_master_video_avalon_master_to_SDRAM_s1_cmd_width_adapter:out_startofpacket -> cmd_mux_001:sink2_startofpacket
	wire          bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_endofpacket;                        // Bus_master_video_avalon_master_to_SDRAM_s1_cmd_width_adapter:out_endofpacket -> cmd_mux_001:sink2_endofpacket
	...
	wire          vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_valid;                              // VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:out_valid -> cmd_mux_001:sink3_valid
	wire  [110:0] vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_data;                               // VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:out_data -> cmd_mux_001:sink3_data
	wire          vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_ready;                              // cmd_mux_001:sink3_ready -> VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:out_ready
	wire    [3:0] vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_channel;                            // VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:out_channel -> cmd_mux_001:sink3_channel
	wire          vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_startofpacket;                      // VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:out_startofpacket -> cmd_mux_001:sink3_startofpacket
	wire          vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_endofpacket;                        // VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:out_endofpacket -> cmd_mux_001:sink3_endofpacket
	...
	wire  [101:0] cmd_demux_003_src1_data;                                                                             // cmd_demux_003:src1_data -> VGA_Subsystem_pixel_dma_master_to_Onchip_SRAM_s2_cmd_width_adapter:in_data
	...
	wire          rsp_demux_src0_valid;                                                                                // rsp_demux:src0_valid -> Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:in_valid
	wire  [128:0] rsp_demux_src0_data;                                                                                 // rsp_demux:src0_data -> Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:in_data
	wire          rsp_demux_src0_ready;                                                                                // Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:in_ready -> rsp_demux:src0_ready
	wire    [3:0] rsp_demux_src0_channel;                                                                              // rsp_demux:src0_channel -> Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:in_channel
	wire          rsp_demux_src0_startofpacket;                                                                        // rsp_demux:src0_startofpacket -> Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_src0_endofpacket;                                                                          // rsp_demux:src0_endofpacket -> Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:in_endofpacket
	wire          onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_valid;                          // Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:out_valid -> rsp_mux:sink0_valid
	wire  [236:0] onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_data;                           // Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:out_data -> rsp_mux:sink0_data
	wire          onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_ready;                          // rsp_mux:sink0_ready -> Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:out_ready
	wire    [3:0] onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_channel;                        // Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:out_channel -> rsp_mux:sink0_channel
	wire          onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_startofpacket;                  // Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:out_startofpacket -> rsp_mux:sink0_startofpacket
	wire          onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_endofpacket;                    // Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:out_endofpacket -> rsp_mux:sink0_endofpacket
	wire          rsp_demux_src1_valid;                                                                                // rsp_demux:src1_valid -> Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:in_valid
	wire  [128:0] rsp_demux_src1_data;                                                                                 // rsp_demux:src1_data -> Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:in_data
	wire          rsp_demux_src1_ready;                                                                                // Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:in_ready -> rsp_demux:src1_ready
	wire    [3:0] rsp_demux_src1_channel;                                                                              // rsp_demux:src1_channel -> Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:in_channel
	wire          rsp_demux_src1_startofpacket;                                                                        // rsp_demux:src1_startofpacket -> Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_src1_endofpacket;                                                                          // rsp_demux:src1_endofpacket -> Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:in_endofpacket
	wire          onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_valid;                          // Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:out_valid -> rsp_mux_001:sink0_valid
	wire  [236:0] onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_data;                           // Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:out_data -> rsp_mux_001:sink0_data
	wire          onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_ready;                          // rsp_mux_001:sink0_ready -> Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:out_ready
	wire    [3:0] onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_channel;                        // Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:out_channel -> rsp_mux_001:sink0_channel
	wire          onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_startofpacket;                  // Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:out_startofpacket -> rsp_mux_001:sink0_startofpacket
	wire          onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_endofpacket;                    // Onchip_SRAM_s1_to_ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:out_endofpacket -> rsp_mux_001:sink0_endofpacket
	wire          rsp_demux_src2_valid;                                                                                // rsp_demux:src2_valid -> Onchip_SRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:in_valid
	wire  [128:0] rsp_demux_src2_data;                                                                                 // rsp_demux:src2_data -> Onchip_SRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:in_data
	wire          rsp_demux_src2_ready;                                                                                // Onchip_SRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:in_ready -> rsp_demux:src2_ready
	wire    [3:0] rsp_demux_src2_channel;                                                                              // rsp_demux:src2_channel -> Onchip_SRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:in_channel
	wire          rsp_demux_src2_startofpacket;                                                                        // rsp_demux:src2_startofpacket -> Onchip_SRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_src2_endofpacket;                                                                          // rsp_demux:src2_endofpacket -> Onchip_SRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:in_endofpacket
	wire          onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_valid;                        // Onchip_SRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:out_valid -> rsp_mux_002:sink0_valid
	wire  [101:0] onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_data;                         // Onchip_SRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:out_data -> rsp_mux_002:sink0_data
	wire          onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_ready;                        // rsp_mux_002:sink0_ready -> Onchip_SRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:out_ready
	wire    [3:0] onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_channel;                      // Onchip_SRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:out_channel -> rsp_mux_002:sink0_channel
	wire          onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_startofpacket;                // Onchip_SRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:out_startofpacket -> rsp_mux_002:sink0_startofpacket
	wire          onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_endofpacket;                  // Onchip_SRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:out_endofpacket -> rsp_mux_002:sink0_endofpacket
	...
	wire          rsp_demux_001_src2_valid;                                                                            // rsp_demux_001:src2_valid -> SDRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:in_valid
	wire  [110:0] rsp_demux_001_src2_data;                                                                             // rsp_demux_001:src2_data -> SDRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:in_data
	wire          rsp_demux_001_src2_ready;                                                                            // SDRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:in_ready -> rsp_demux_001:src2_ready
	wire    [3:0] rsp_demux_001_src2_channel;                                                                          // rsp_demux_001:src2_channel -> SDRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:in_channel
	wire          rsp_demux_001_src2_startofpacket;                                                                    // rsp_demux_001:src2_startofpacket -> SDRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_001_src2_endofpacket;                                                                      // rsp_demux_001:src2_endofpacket -> SDRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:in_endofpacket
	wire          sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_valid;                              // SDRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:out_valid -> rsp_mux_002:sink1_valid
	wire  [101:0] sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_data;                               // SDRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:out_data -> rsp_mux_002:sink1_data
	wire          sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_ready;                              // rsp_mux_002:sink1_ready -> SDRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:out_ready
	wire    [3:0] sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_channel;                            // SDRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:out_channel -> rsp_mux_002:sink1_channel
	wire          sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_startofpacket;                      // SDRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:out_startofpacket -> rsp_mux_002:sink1_startofpacket
	wire          sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_endofpacket;                        // SDRAM_s1_to_Bus_master_video_avalon_master_rsp_width_adapter:out_endofpacket -> rsp_mux_002:sink1_endofpacket
	wire          rsp_demux_001_src3_valid;                                                                            // rsp_demux_001:src3_valid -> SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_valid
	wire  [110:0] rsp_demux_001_src3_data;                                                                             // rsp_demux_001:src3_data -> SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_data
	wire          rsp_demux_001_src3_ready;                                                                            // SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_ready -> rsp_demux_001:src3_ready
	wire    [3:0] rsp_demux_001_src3_channel;                                                                          // rsp_demux_001:src3_channel -> SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_channel
	wire          rsp_demux_001_src3_startofpacket;                                                                    // rsp_demux_001:src3_startofpacket -> SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_001_src3_endofpacket;                                                                      // rsp_demux_001:src3_endofpacket -> SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_endofpacket
	...
	wire  [101:0] onchip_sram_s2_to_vga_subsystem_pixel_dma_master_rsp_width_adapter_src_data;                         // Onchip_SRAM_s2_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_data -> rsp_mux_003:sink1_data
	...
	) bus_master_video_avalon_master_translator (
		.clk                    (System_PLL_sys_clk_clk),                                                            //                       clk.clk
		.reset                  (Bus_master_video_reset_reset_bridge_in_reset_reset),                                //                     reset.reset
		.uav_address            (bus_master_video_avalon_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (bus_master_video_avalon_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (bus_master_video_avalon_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (bus_master_video_avalon_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (bus_master_video_avalon_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (bus_master_video_avalon_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (bus_master_video_avalon_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (bus_master_video_avalon_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (bus_master_video_avalon_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (bus_master_video_avalon_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (bus_master_video_avalon_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (Bus_master_video_avalon_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (Bus_master_video_avalon_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (Bus_master_video_avalon_master_byteenable),                                         //                          .byteenable
		.av_read                (Bus_master_video_avalon_master_read),                                               //                          .read
		.av_readdata            (Bus_master_video_avalon_master_readdata),                                           //                          .readdata
		.av_write               (Bus_master_video_avalon_master_write),                                              //                          .write
		.av_writedata           (Bus_master_video_avalon_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) bus_master_video_avalon_master_agent (
		.clk                   (System_PLL_sys_clk_clk),                                                            //       clk.clk
		.reset                 (Bus_master_video_reset_reset_bridge_in_reset_reset),                                // clk_reset.reset
		.av_address            (bus_master_video_avalon_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (bus_master_video_avalon_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (bus_master_video_avalon_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (bus_master_video_avalon_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (bus_master_video_avalon_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (bus_master_video_avalon_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (bus_master_video_avalon_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (bus_master_video_avalon_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (bus_master_video_avalon_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (bus_master_video_avalon_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (bus_master_video_avalon_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (bus_master_video_avalon_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (bus_master_video_avalon_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (bus_master_video_avalon_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (bus_master_video_avalon_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (bus_master_video_avalon_master_agent_cp_ready),                                     //          .ready
	...
	Computer_System_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (bus_master_video_avalon_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (bus_master_video_avalon_master_agent_cp_valid),         //          .valid
		.sink_data          (bus_master_video_avalon_master_agent_cp_data),          //          .data
		.sink_startofpacket (bus_master_video_avalon_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (bus_master_video_avalon_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                                //       clk.clk
		.reset              (Bus_master_video_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (Bus_master_video_reset_reset_bridge_in_reset_reset), // cr0_reset.reset
	...
	Computer_System_mm_interconnect_0_cmd_mux cmd_mux (
		...
		.sink2_ready         (bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_ready),         //     sink2.ready
		.sink2_valid         (bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_valid),         //          .valid
		.sink2_channel       (bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink2_data          (bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_data),          //          .data
		.sink2_startofpacket (bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink2_endofpacket   (bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_endofpacket)    //          .endofpacket
	);
	...
	Computer_System_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		...
		.sink2_ready         (bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_ready),         //     sink2.ready
		.sink2_valid         (bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_valid),         //          .valid
		.sink2_channel       (bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink2_data          (bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_data),          //          .data
		.sink2_startofpacket (bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink2_endofpacket   (bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
	...
	Computer_System_mm_interconnect_0_rsp_mux rsp_mux (
		...
		.sink0_ready         (onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_ready),                          //     sink0.ready
		.sink0_valid         (onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_valid),                          //          .valid
		.sink0_channel       (onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_channel),                        //          .channel
		.sink0_data          (onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_data),                           //          .data
		.sink0_startofpacket (onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_startofpacket),                  //          .startofpacket
		.sink0_endofpacket   (onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_endofpacket),                    //          .endofpacket
	...
	Computer_System_mm_interconnect_0_rsp_mux rsp_mux_001 (
		...
		.sink0_ready         (onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_ready),                          //     sink0.ready
		.sink0_valid         (onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_valid),                          //          .valid
		.sink0_channel       (onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_channel),                        //          .channel
		.sink0_data          (onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_data),                           //          .data
		.sink0_startofpacket (onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_startofpacket),                  //          .startofpacket
		.sink0_endofpacket   (onchip_sram_s1_to_arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_endofpacket),                    //          .endofpacket
	...
	Computer_System_mm_interconnect_0_rsp_mux_002 rsp_mux_002 (
		...
		.sink0_ready         (onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_ready),         //     sink0.ready
		.sink0_valid         (onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_valid),         //          .valid
		.sink0_channel       (onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_channel),       //          .channel
		.sink0_data          (onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_data),          //          .data
		.sink0_startofpacket (onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket   (onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink1_ready         (sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_ready),               //     sink1.ready
		.sink1_valid         (sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_valid),               //          .valid
		.sink1_channel       (sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_channel),             //          .channel
		.sink1_data          (sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_data),                //          .data
		.sink1_startofpacket (sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_startofpacket),       //          .startofpacket
		.sink1_endofpacket   (sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_endofpacket)          //          .endofpacket
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                                               //       clk.clk
		.reset                (Bus_master_video_reset_reset_bridge_in_reset_reset),                                   // clk_reset.reset
		...
		.out_endofpacket      (bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (bus_master_video_avalon_master_to_onchip_sram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                                // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                                         //       clk.clk
		.reset                (Bus_master_video_reset_reset_bridge_in_reset_reset),                             // clk_reset.reset
		...
		.out_endofpacket      (bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (bus_master_video_avalon_master_to_sdram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                          // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                                               //       clk.clk
		.reset                (Bus_master_video_reset_reset_bridge_in_reset_reset),                                   // clk_reset.reset
		...
		.out_endofpacket      (onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (onchip_sram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                                // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                                         //       clk.clk
		.reset                (Bus_master_video_reset_reset_bridge_in_reset_reset),                             // clk_reset.reset
		...
		.out_endofpacket      (sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sdram_s1_to_bus_master_video_avalon_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                          // (terminated)
	);
	...
	Computer_System_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (Bus_master_video_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
