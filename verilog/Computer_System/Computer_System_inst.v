	Computer_System u0 (
		...
		.bus_master_video_external_interface_address     (<connected-to-bus_master_video_external_interface_address>),     // bus_master_video_external_interface.address
		.bus_master_video_external_interface_byte_enable (<connected-to-bus_master_video_external_interface_byte_enable>), //                                    .byte_enable
		.bus_master_video_external_interface_read        (<connected-to-bus_master_video_external_interface_read>),        //                                    .read
		.bus_master_video_external_interface_write       (<connected-to-bus_master_video_external_interface_write>),       //                                    .write
		.bus_master_video_external_interface_write_data  (<connected-to-bus_master_video_external_interface_write_data>),  //                                    .write_data
		.bus_master_video_external_interface_acknowledge (<connected-to-bus_master_video_external_interface_acknowledge>), //                                    .acknowledge
		.bus_master_video_external_interface_read_data   (<connected-to-bus_master_video_external_interface_read_data>),   //                                    .read_data
