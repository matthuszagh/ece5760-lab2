...
module system_mm_interconnect_0 (
		...
		output wire [3:0]  ram_s1_address,                         //                           ram_s1.address
	...
	wire   [93:0] ram_s1_agent_rp_data;                                 // ram_s1_agent:rp_data -> router_002:sink_data
	...
	wire   [93:0] ram_s1_burst_adapter_source0_data;                    // ram_s1_burst_adapter:source0_data -> ram_s1_agent:cp_data
	...
	wire   [93:0] router_002_src_data;                                  // router_002:src_data -> ram_s1_rsp_width_adapter:in_data
	...
	wire  [111:0] ram_s1_rsp_width_adapter_src_data;                    // ram_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [111:0] cmd_mux_src_data;                                     // cmd_mux:src_data -> ram_s1_cmd_width_adapter:in_data
	...
	wire   [93:0] ram_s1_cmd_width_adapter_src_data;                    // ram_s1_cmd_width_adapter:out_data -> ram_s1_burst_adapter:sink0_data
	...
	wire   [17:0] ram_s1_agent_rdata_fifo_out_data;                     // ram_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	...
	wire   [17:0] avalon_st_adapter_out_0_data;                         // avalon_st_adapter:out_0_data -> ram_s1_agent:rdata_fifo_sink_data
	...
	altera_merlin_axi_master_ni #(
		...
		.aresetn                (~ram_reset1_reset_bridge_in_reset_reset),              //        clk_reset.reset_n
