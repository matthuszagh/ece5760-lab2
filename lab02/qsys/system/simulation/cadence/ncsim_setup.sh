...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/system_video_pll_0_video_pll.vo"             -work video_pll         -cdslib ./cds_libs/video_pll.cds.lib        
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/system_video_pll_0.v"                        -work video_pll_0       -cdslib ./cds_libs/video_pll_0.cds.lib      
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/system.v"                                                                                                                   
fi
