...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/system_video_pll_0_video_pll.vo"             -work video_pll        
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/system_video_pll_0.v"                        -work video_pll_0      
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/system.v"                                                                      
fi
