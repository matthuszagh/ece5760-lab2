/* This file provides address values that exist in the DE1-SoC Computer System,
 * built by Altera.
 *
 * These addresses were specified when configuring the FPGA fabric. They are
 * physical memory addresses, but only became so after the Verilog was
 * synthesized.
 */
...
// FPGA pixel buffer for the video-in and video out ports
#define FPGA_ONCHIP_BASE      0xC8000000
#define FPGA_ONCHIP_END       0xC803FFFF    // memory portion devoted to the
                                            // pixel buffer is less than the
                                            // total span.
#define FPGA_ONCHIP_SPAN      0x00080000    // modified for 640x480 -
                                            // was 0x00040000 for 320x240
// FPGA character buffer for the video-out port
